...
case "$COMMAND" in
    ...
    ######################################
    "build-simulator")
        build_framework CreditorCommerceLibraryiOS iphonesimulator './build'
        exit 0
        ;;
    ...
    ######################################
    "build-device")
        build_framework CreditorCommerceLibraryiOS iphoneos './build'
        exit 0
        ;;
    ...
    "package-ios-simulator")
        ...
        rm -rf ../CreditorCommerceLibraryiOS.build
        rm -rf ../XCBuildData
